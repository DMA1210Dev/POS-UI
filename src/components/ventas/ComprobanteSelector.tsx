    ...
    <div className="space-y-2">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg outline-none focus:border-brand-500 bg-white disabled:opacity-60 disabled:cursor-not-allowed disabled:bg-slate-50"
        >
      ...
      {esTipoB && tipoComprobanteId && ncfReservado && !reservando && (
        <div className="rounded-lg border border-success-200 bg-success-50 px-3 py-2.5 space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-success-700 flex items-center gap-1.5">
              <Lock size={11} />
              NCF reservado para este carrito
            </span>
            <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-success-100 text-success-700">
              Confirmado
            </span>
          </div>
          <div className="font-mono text-sm font-bold text-success-900 tracking-wider">
            {ncfReservado}
          </div>
      ...
      {esTipoE && tipoComprobanteId && (
        <div className="rounded-lg border border-warning-100 bg-warning-50 px-3 py-2.5 space-y-1">
          <div className="flex items-center gap-1.5 text-xs font-medium text-warning-700">
            <WifiOff size={11} />
