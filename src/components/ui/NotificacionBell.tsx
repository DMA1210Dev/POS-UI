...
export default function NotificacionBell() {
  ...
  const { data: notificaciones = [] } = useQuery<NotificacionResponse[]>({
    ...
    // No lanzar error si el endpoint aún no existe
    retry: false,
    gcTime: 60_000,
  })
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 w-80 bg-white rounded-xl shadow-2xl border border-slate-200 z-[200] overflow-hidden">
          {/* Cabecera */}
