        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              {productos.map(p => (
                <tr key={p.id} className="hover:bg-danger-50">
                  ...
                  <td className="px-4 py-3 font-bold text-danger-600">{p.stock}</td>
              ...
              {!isLoading && productos.length === 0 && (
                <tr><td colSpan={6} className="px-4 py-12 text-center text-success-600 font-medium">✓ Todos los productos tienen stock suficiente</td></tr>
              )}
            </tbody>
          </table>
        </div>
